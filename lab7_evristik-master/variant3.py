...
def main(O_main, vector, M, N, best_copy, p_cros, p_mut, O_count, o_for_v2=None):
    O = O_main
    O_for_tour = []
    count_years = 0
    best_count = 0
    ...
    def find_the_best(o_main):
        o_sorted = sorted(o_main, key=lambda o: minmax(fenotype(o)))
        return o_sorted[0]
    # print_matrix(vector)
    # print_matrix(O)
